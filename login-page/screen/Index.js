          ...
          <Text style={styles.caption}>Login</Text>
            <View style={styles.content}>
              ...
              <View style={styles.kotak_login}>
                <Text style = {styles.teks_login}>Login</Text>
              </View>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => navigation.navigate('Register')}>
              <View style={styles.kotak_register}>
                <Text style = {styles.teks_register}>Register</Text>
              </View>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => navigation.navigate('Password')}><Text style = {styles.password}
